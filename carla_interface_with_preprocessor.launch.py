...
if DEFAULT_AUTOWARE_CARLA_INTERFACE_DIR is None:
    workspace_local_dir = os.path.join(THIS_DIR, "autoware_carla_interface")
...
def generate_launch_description():
    ...
    pointcloud_preprocessor = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(THIS_DIR, "carla_pointcloud_preprocessor.launch.py")
        ),
        launch_arguments={
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                ...
                default_value="autoware_crop_box_filter",
            ),
            DeclareLaunchArgument(
                "crop_box_filter_plugin",
                default_value="autoware::crop_box_filter::CropBoxFilter",
            ),
            interface_launch,
