...
bool autoware_internal_perception_msgs__msg__segmentation_mask__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_internal_perception_msgs.msg._segmentation_mask.SegmentationMask", full_classname_dest, 73) == 0);
  }
  autoware_internal_perception_msgs__msg__SegmentationMask * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of SegmentationMask */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_internal_perception_msgs.msg._segmentation_mask");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SegmentationMask");
