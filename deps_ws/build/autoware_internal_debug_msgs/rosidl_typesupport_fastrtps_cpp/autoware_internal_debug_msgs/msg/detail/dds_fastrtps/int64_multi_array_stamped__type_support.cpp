...
#include "autoware_internal_debug_msgs/msg/detail/int64_multi_array_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_internal_debug_msgs::msg::Int64MultiArrayStamped & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_internal_debug_msgs::msg::Int64MultiArrayStamped & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_internal_debug_msgs::msg::Int64MultiArrayStamped;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_internal_debug_msgs::msg::Int64MultiArrayStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_internal_debug_msgs::msg::Int64MultiArrayStamped *>(
    untyped_ros_message);
...
get_message_type_support_handle<autoware_internal_debug_msgs::msg::Int64MultiArrayStamped>()
{
  return &autoware_internal_debug_msgs::msg::typesupport_fastrtps_cpp::_Int64MultiArrayStamped__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_internal_debug_msgs, msg, Int64MultiArrayStamped)() {
  return &autoware_internal_debug_msgs::msg::typesupport_fastrtps_cpp::_Int64MultiArrayStamped__handle;
}
