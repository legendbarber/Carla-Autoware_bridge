...
#include "autoware_internal_debug_msgs/msg/detail/service_log__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_internal_debug_msgs::msg::ServiceLog & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_internal_debug_msgs::msg::ServiceLog & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_internal_debug_msgs::msg::ServiceLog;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_internal_debug_msgs::msg::ServiceLog *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_internal_debug_msgs::msg::ServiceLog *>(
    untyped_ros_message);
...
get_message_type_support_handle<autoware_internal_debug_msgs::msg::ServiceLog>()
{
  return &autoware_internal_debug_msgs::msg::typesupport_fastrtps_cpp::_ServiceLog__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_internal_debug_msgs, msg, ServiceLog)() {
  return &autoware_internal_debug_msgs::msg::typesupport_fastrtps_cpp::_ServiceLog__handle;
}
