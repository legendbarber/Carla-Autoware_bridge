...
#include "autoware_internal_debug_msgs/srv/detail/string__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_internal_debug_msgs::srv::String_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_internal_debug_msgs::srv::String_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_internal_debug_msgs::srv::String_Request *>(
    untyped_ros_message);
...
get_message_type_support_handle<autoware_internal_debug_msgs::srv::String_Request>()
{
  return &autoware_internal_debug_msgs::srv::typesupport_fastrtps_cpp::_String_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = autoware_internal_debug_msgs::srv::String_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_internal_debug_msgs::srv::String_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<autoware_internal_debug_msgs::srv::String_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_autoware_internal_debug_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<autoware_internal_debug_msgs::srv::String_Response>()
{
  return &autoware_internal_debug_msgs::srv::typesupport_fastrtps_cpp::_String_Response__handle;
}
...
get_service_type_support_handle<autoware_internal_debug_msgs::srv::String>()
{
  return &autoware_internal_debug_msgs::srv::typesupport_fastrtps_cpp::_String__handle;
}
