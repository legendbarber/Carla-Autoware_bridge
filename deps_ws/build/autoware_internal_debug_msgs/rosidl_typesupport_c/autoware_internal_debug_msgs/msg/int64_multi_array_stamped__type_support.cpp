...
static const _Int64MultiArrayStamped_type_support_symbol_names_t _Int64MultiArrayStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_internal_debug_msgs, msg, Int64MultiArrayStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_internal_debug_msgs, msg, Int64MultiArrayStamped)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_internal_debug_msgs, msg, Int64MultiArrayStamped)() {
  return &::autoware_internal_debug_msgs::msg::rosidl_typesupport_c::Int64MultiArrayStamped_message_type_support_handle;
}
