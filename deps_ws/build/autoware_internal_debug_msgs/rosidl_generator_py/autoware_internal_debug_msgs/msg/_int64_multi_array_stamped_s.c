...
bool autoware_internal_debug_msgs__msg__int64_multi_array_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_internal_debug_msgs.msg._int64_multi_array_stamped.Int64MultiArrayStamped", full_classname_dest, 82) == 0);
  }
  autoware_internal_debug_msgs__msg__Int64MultiArrayStamped * ros_message = _ros_message;
  {  // stamp
...
PyObject * autoware_internal_debug_msgs__msg__int64_multi_array_stamped__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_internal_debug_msgs.msg._int64_multi_array_stamped");
