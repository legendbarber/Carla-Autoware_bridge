...
bool autoware_internal_debug_msgs__msg__float64_multi_array_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_internal_debug_msgs.msg._float64_multi_array_stamped.Float64MultiArrayStamped", full_classname_dest, 86) == 0);
  }
  autoware_internal_debug_msgs__msg__Float64MultiArrayStamped * ros_message = _ros_message;
  {  // stamp
...
PyObject * autoware_internal_debug_msgs__msg__float64_multi_array_stamped__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_internal_debug_msgs.msg._float64_multi_array_stamped");
