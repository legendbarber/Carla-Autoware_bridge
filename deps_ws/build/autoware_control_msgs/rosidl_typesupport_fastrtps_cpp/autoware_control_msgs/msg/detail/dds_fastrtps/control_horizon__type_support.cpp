...
#include "autoware_control_msgs/msg/detail/control_horizon__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const autoware_control_msgs::msg::Control &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  size_t current_alignment)
{
  ...
  // Member: controls
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        autoware_control_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Control(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = autoware_control_msgs::msg::ControlHorizon;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_control_msgs::msg::ControlHorizon *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_control_msgs::msg::ControlHorizon *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ControlHorizon__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const autoware_control_msgs::msg::ControlHorizon *>(
...
static size_t _ControlHorizon__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ControlHorizon(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ControlHorizon__callbacks = {
...
static rosidl_message_type_support_t _ControlHorizon__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ControlHorizon__callbacks,
...
{
  return &autoware_control_msgs::msg::typesupport_fastrtps_cpp::_ControlHorizon__handle;
}
