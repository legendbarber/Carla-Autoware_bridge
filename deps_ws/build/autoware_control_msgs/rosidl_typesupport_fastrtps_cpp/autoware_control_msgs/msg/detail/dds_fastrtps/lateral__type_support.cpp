...
#include "autoware_control_msgs/msg/detail/lateral__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_control_msgs::msg::Lateral;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_control_msgs::msg::Lateral *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_control_msgs::msg::Lateral *>(
    untyped_ros_message);
...
{
  return &autoware_control_msgs::msg::typesupport_fastrtps_cpp::_Lateral__handle;
}
