...
#define NODE_MAIN_LOGGER_NAME "autoware_raw_vehicle_cmd_converter_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libautoware_raw_vehicle_cmd_converter_node_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<autoware::raw_vehicle_cmd_converter::RawVehicleCommandConverterNode>";
