...
#ifndef AUTOWARE_PERCEPTION_MSGS__MSG__DETAIL__DETECTED_OBJECT_KINEMATICS__STRUCT_HPP_
#define AUTOWARE_PERCEPTION_MSGS__MSG__DETAIL__DETECTED_OBJECT_KINEMATICS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__autoware_perception_msgs__msg__DetectedObjectKinematics __attribute__((deprecated))
#else
# define DEPRECATED__autoware_perception_msgs__msg__DetectedObjectKinematics __declspec(deprecated)
#endif
...
struct DetectedObjectKinematics_
{
  ...
  using ConstRawPtr =
    const autoware_perception_msgs::msg::DetectedObjectKinematics_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<autoware_perception_msgs::msg::DetectedObjectKinematics_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<autoware_perception_msgs::msg::DetectedObjectKinematics_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      autoware_perception_msgs::msg::DetectedObjectKinematics_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<autoware_perception_msgs::msg::DetectedObjectKinematics_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<autoware_perception_msgs::msg::DetectedObjectKinematics_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<autoware_perception_msgs::msg::DetectedObjectKinematics_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<autoware_perception_msgs::msg::DetectedObjectKinematics_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__autoware_perception_msgs__msg__DetectedObjectKinematics
    std::shared_ptr<autoware_perception_msgs::msg::DetectedObjectKinematics_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__autoware_perception_msgs__msg__DetectedObjectKinematics
    std::shared_ptr<autoware_perception_msgs::msg::DetectedObjectKinematics_<ContainerAllocator> const>
...
using DetectedObjectKinematics =
  autoware_perception_msgs::msg::DetectedObjectKinematics_<std::allocator<void>>;
...
#endif  // AUTOWARE_PERCEPTION_MSGS__MSG__DETAIL__DETECTED_OBJECT_KINEMATICS__STRUCT_HPP_
