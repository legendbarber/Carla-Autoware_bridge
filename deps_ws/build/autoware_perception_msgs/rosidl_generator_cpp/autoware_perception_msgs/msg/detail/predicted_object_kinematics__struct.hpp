...
struct PredictedObjectKinematics_
{
  ...
  using _predicted_paths_type =
    std::vector<autoware_perception_msgs::msg::PredictedPath_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<autoware_perception_msgs::msg::PredictedPath_<ContainerAllocator>>>;
  ...
  Type & set__predicted_paths(
    const std::vector<autoware_perception_msgs::msg::PredictedPath_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<autoware_perception_msgs::msg::PredictedPath_<ContainerAllocator>>> & _arg)
  {
