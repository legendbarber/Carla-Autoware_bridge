...
#include "autoware_perception_msgs/msg/detail/detected_objects__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_perception_msgs::msg::DetectedObjects & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_perception_msgs::msg::DetectedObjects & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        autoware_perception_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_DetectedObject(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = autoware_perception_msgs::msg::DetectedObjects;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_perception_msgs::msg::DetectedObjects *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_perception_msgs::msg::DetectedObjects *>(
    untyped_ros_message);
...
get_message_type_support_handle<autoware_perception_msgs::msg::DetectedObjects>()
{
  return &autoware_perception_msgs::msg::typesupport_fastrtps_cpp::_DetectedObjects__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_perception_msgs, msg, DetectedObjects)() {
  return &autoware_perception_msgs::msg::typesupport_fastrtps_cpp::_DetectedObjects__handle;
}
