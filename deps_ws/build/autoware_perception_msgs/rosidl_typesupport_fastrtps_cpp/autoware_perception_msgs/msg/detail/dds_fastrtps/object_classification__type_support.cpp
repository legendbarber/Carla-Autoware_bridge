...
#include "autoware_perception_msgs/msg/detail/object_classification__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_perception_msgs::msg::ObjectClassification & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_perception_msgs::msg::ObjectClassification & ros_message)
{
  // Member: label
  cdr >> ros_message.label;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_perception_msgs::msg::ObjectClassification;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_perception_msgs::msg::ObjectClassification *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_perception_msgs::msg::ObjectClassification *>(
    untyped_ros_message);
...
get_message_type_support_handle<autoware_perception_msgs::msg::ObjectClassification>()
{
  return &autoware_perception_msgs::msg::typesupport_fastrtps_cpp::_ObjectClassification__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_perception_msgs, msg, ObjectClassification)() {
  return &autoware_perception_msgs::msg::typesupport_fastrtps_cpp::_ObjectClassification__handle;
}
