...
#include "autoware_perception_msgs/msg/detail/detected_object_kinematics__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_perception_msgs::msg::DetectedObjectKinematics & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_perception_msgs::msg::DetectedObjectKinematics & ros_message)
{
  // Member: pose_with_covariance
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_perception_msgs::msg::DetectedObjectKinematics;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_perception_msgs::msg::DetectedObjectKinematics *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_perception_msgs::msg::DetectedObjectKinematics *>(
    untyped_ros_message);
...
get_message_type_support_handle<autoware_perception_msgs::msg::DetectedObjectKinematics>()
{
  return &autoware_perception_msgs::msg::typesupport_fastrtps_cpp::_DetectedObjectKinematics__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_perception_msgs, msg, DetectedObjectKinematics)() {
  return &autoware_perception_msgs::msg::typesupport_fastrtps_cpp::_DetectedObjectKinematics__handle;
}
