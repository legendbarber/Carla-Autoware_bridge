...
#ifndef AUTOWARE_ADAPI_V1_MSGS__MSG__DETAIL__OBJECT_CLASSIFICATION__STRUCT_HPP_
#define AUTOWARE_ADAPI_V1_MSGS__MSG__DETAIL__OBJECT_CLASSIFICATION__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__autoware_adapi_v1_msgs__msg__ObjectClassification __attribute__((deprecated))
#else
# define DEPRECATED__autoware_adapi_v1_msgs__msg__ObjectClassification __declspec(deprecated)
#endif
...
struct ObjectClassification_
{
  ...
  // pointer types
  using RawPtr =
    autoware_adapi_v1_msgs::msg::ObjectClassification_<ContainerAllocator> *;
  using ConstRawPtr =
    const autoware_adapi_v1_msgs::msg::ObjectClassification_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<autoware_adapi_v1_msgs::msg::ObjectClassification_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<autoware_adapi_v1_msgs::msg::ObjectClassification_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      autoware_adapi_v1_msgs::msg::ObjectClassification_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<autoware_adapi_v1_msgs::msg::ObjectClassification_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<autoware_adapi_v1_msgs::msg::ObjectClassification_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<autoware_adapi_v1_msgs::msg::ObjectClassification_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<autoware_adapi_v1_msgs::msg::ObjectClassification_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__autoware_adapi_v1_msgs__msg__ObjectClassification
    std::shared_ptr<autoware_adapi_v1_msgs::msg::ObjectClassification_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__autoware_adapi_v1_msgs__msg__ObjectClassification
    std::shared_ptr<autoware_adapi_v1_msgs::msg::ObjectClassification_<ContainerAllocator> const>
...
using ObjectClassification =
  autoware_adapi_v1_msgs::msg::ObjectClassification_<std::allocator<void>>;
...
#endif  // AUTOWARE_ADAPI_V1_MSGS__MSG__DETAIL__OBJECT_CLASSIFICATION__STRUCT_HPP_
