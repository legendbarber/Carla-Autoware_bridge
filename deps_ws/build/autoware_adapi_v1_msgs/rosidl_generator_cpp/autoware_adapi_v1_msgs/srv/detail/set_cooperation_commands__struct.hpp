...
struct SetCooperationCommands_Request_
{
  ...
  using _commands_type =
    std::vector<autoware_adapi_v1_msgs::msg::CooperationCommand_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<autoware_adapi_v1_msgs::msg::CooperationCommand_<ContainerAllocator>>>;
  _commands_type commands;

  // setters for named parameter idiom
  Type & set__commands(
    const std::vector<autoware_adapi_v1_msgs::msg::CooperationCommand_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<autoware_adapi_v1_msgs::msg::CooperationCommand_<ContainerAllocator>>> & _arg)
  {
    this->commands = _arg;
    return *this;
  }
