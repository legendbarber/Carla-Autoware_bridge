...
#include "autoware_adapi_v1_msgs/msg/detail/door_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_adapi_v1_msgs::msg::DoorStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_adapi_v1_msgs::msg::DoorStatus & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_adapi_v1_msgs::msg::DoorStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_adapi_v1_msgs::msg::DoorStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_adapi_v1_msgs::msg::DoorStatus *>(
    untyped_ros_message);
...
get_message_type_support_handle<autoware_adapi_v1_msgs::msg::DoorStatus>()
{
  return &autoware_adapi_v1_msgs::msg::typesupport_fastrtps_cpp::_DoorStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_adapi_v1_msgs, msg, DoorStatus)() {
  return &autoware_adapi_v1_msgs::msg::typesupport_fastrtps_cpp::_DoorStatus__handle;
}
