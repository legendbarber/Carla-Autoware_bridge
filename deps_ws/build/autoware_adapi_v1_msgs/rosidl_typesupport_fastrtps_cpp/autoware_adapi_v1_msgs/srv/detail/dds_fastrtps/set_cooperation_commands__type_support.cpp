  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_adapi_v1_msgs::srv::SetCooperationCommands_Request;
    is_plain =
      (
...
static size_t _SetCooperationCommands_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetCooperationCommands_Request(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = autoware_adapi_v1_msgs::srv::SetCooperationCommands_Response;
    is_plain =
      (
...
static size_t _SetCooperationCommands_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetCooperationCommands_Response(full_bounded, is_plain, 0);
