  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_adapi_v1_msgs::srv::GetVehicleDimensions_Request;
    is_plain =
      (
...
static size_t _GetVehicleDimensions_Request__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_GetVehicleDimensions_Request(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = autoware_adapi_v1_msgs::srv::GetVehicleDimensions_Response;
    is_plain =
      (
...
static size_t _GetVehicleDimensions_Response__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_GetVehicleDimensions_Response(full_bounded, is_plain, 0);
