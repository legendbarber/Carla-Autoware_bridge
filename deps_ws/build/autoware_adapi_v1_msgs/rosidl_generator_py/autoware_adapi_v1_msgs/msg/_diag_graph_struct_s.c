...
bool autoware_adapi_v1_msgs__msg__diag_leaf_struct__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool autoware_adapi_v1_msgs__msg__diag_graph_struct__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // diags
    ...
    if (!autoware_adapi_v1_msgs__msg__DiagLeafStruct__Sequence__init(&(ros_message->diags), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create autoware_adapi_v1_msgs__msg__DiagLeafStruct__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    autoware_adapi_v1_msgs__msg__DiagLeafStruct * dest = ros_message->diags.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!autoware_adapi_v1_msgs__msg__diag_leaf_struct__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * autoware_adapi_v1_msgs__msg__diag_graph_struct__convert_to_py(void * raw_ros_message)
{
  ...
  {  // diags
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = autoware_adapi_v1_msgs__msg__diag_leaf_struct__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
