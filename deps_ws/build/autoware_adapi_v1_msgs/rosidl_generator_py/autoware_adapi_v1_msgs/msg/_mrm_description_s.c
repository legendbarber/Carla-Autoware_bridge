...
bool autoware_adapi_v1_msgs__msg__mrm_description__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_adapi_v1_msgs.msg._mrm_description.MrmDescription", full_classname_dest, 58) == 0);
  }
  autoware_adapi_v1_msgs__msg__MrmDescription * ros_message = _ros_message;
  {  // behavior
...
{
  /* NOTE(esteve): Call constructor of MrmDescription */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_adapi_v1_msgs.msg._mrm_description");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MrmDescription");
