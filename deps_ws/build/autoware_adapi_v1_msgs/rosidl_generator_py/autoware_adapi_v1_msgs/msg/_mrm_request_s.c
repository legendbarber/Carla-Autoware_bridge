...
bool autoware_adapi_v1_msgs__msg__mrm_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_adapi_v1_msgs.msg._mrm_request.MrmRequest", full_classname_dest, 50) == 0);
  }
  autoware_adapi_v1_msgs__msg__MrmRequest * ros_message = _ros_message;
  {  // sender
  ...
  {  // strategy
    ...
    ros_message->strategy = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of MrmRequest */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_adapi_v1_msgs.msg._mrm_request");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MrmRequest");
  ...
  {  // strategy
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->strategy);
    {
