...
#include "autoware_adapi_v1_msgs/msg/detail/dynamic_object_path__rosidl_typesupport_fastrtps_c.h"
...
using _DynamicObjectPath__ros_msg_type = autoware_adapi_v1_msgs__msg__DynamicObjectPath;

static bool _DynamicObjectPath__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _DynamicObjectPath__ros_msg_type * ros_message = static_cast<const _DynamicObjectPath__ros_msg_type *>(untyped_ros_message);
  // Field name: path
  {
...
static bool _DynamicObjectPath__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _DynamicObjectPath__ros_msg_type * ros_message = static_cast<_DynamicObjectPath__ros_msg_type *>(untyped_ros_message);
  // Field name: path
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _DynamicObjectPath__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_adapi_v1_msgs__msg__DynamicObjectPath(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_adapi_v1_msgs__msg__DynamicObjectPath;
    is_plain =
      (
...
static size_t _DynamicObjectPath__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_autoware_adapi_v1_msgs__msg__DynamicObjectPath(
...
static message_type_support_callbacks_t __callbacks_DynamicObjectPath = {
  "autoware_adapi_v1_msgs::msg",
  "DynamicObjectPath",
  _DynamicObjectPath__cdr_serialize,
  _DynamicObjectPath__cdr_deserialize,
  _DynamicObjectPath__get_serialized_size,
  _DynamicObjectPath__max_serialized_size
};

static rosidl_message_type_support_t _DynamicObjectPath__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_DynamicObjectPath,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_adapi_v1_msgs, msg, DynamicObjectPath)() {
  return &_DynamicObjectPath__type_support;
}
