...
#include "autoware_planning_msgs/srv/detail/set_waypoint_route__rosidl_typesupport_fastrtps_c.h"
...
using _SetWaypointRoute_Request__ros_msg_type = autoware_planning_msgs__srv__SetWaypointRoute_Request;
...
size_t get_serialized_size_autoware_planning_msgs__srv__SetWaypointRoute_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetWaypointRoute_Request__ros_msg_type * ros_message = static_cast<const _SetWaypointRoute_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SetWaypointRoute_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_planning_msgs__srv__SetWaypointRoute_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_planning_msgs
size_t max_serialized_size_autoware_planning_msgs__srv__SetWaypointRoute_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_planning_msgs__srv__SetWaypointRoute_Request;
    is_plain =
      (
...
static size_t _SetWaypointRoute_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autoware_planning_msgs__srv__SetWaypointRoute_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_planning_msgs, srv, SetWaypointRoute_Request)() {
...
using _SetWaypointRoute_Response__ros_msg_type = autoware_planning_msgs__srv__SetWaypointRoute_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_planning_msgs
size_t get_serialized_size_autoware_planning_msgs__srv__SetWaypointRoute_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetWaypointRoute_Response__ros_msg_type * ros_message = static_cast<const _SetWaypointRoute_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_planning_msgs__srv__SetWaypointRoute_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_planning_msgs
size_t max_serialized_size_autoware_planning_msgs__srv__SetWaypointRoute_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = autoware_planning_msgs__srv__SetWaypointRoute_Response;
    is_plain =
      (
...
static size_t _SetWaypointRoute_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autoware_planning_msgs__srv__SetWaypointRoute_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_planning_msgs, srv, SetWaypointRoute_Response)() {
...
// already included above
// #include "autoware_planning_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "autoware_planning_msgs/srv/set_waypoint_route.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_planning_msgs, srv, SetWaypointRoute)() {
