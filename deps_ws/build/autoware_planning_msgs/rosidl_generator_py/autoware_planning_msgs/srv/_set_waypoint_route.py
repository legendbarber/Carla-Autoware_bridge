...
class Metaclass_SetWaypointRoute(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from autoware_planning_msgs.srv import _set_waypoint_route
...
class SetWaypointRoute(metaclass=Metaclass_SetWaypointRoute):
    from autoware_planning_msgs.srv._set_waypoint_route import SetWaypointRoute_Request as Request
    from autoware_planning_msgs.srv._set_waypoint_route import SetWaypointRoute_Response as Response
