...
bool autoware_planning_msgs__srv__set_waypoint_route__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_planning_msgs.srv._set_waypoint_route.SetWaypointRoute_Request", full_classname_dest, 71) == 0);
  }
  autoware_planning_msgs__srv__SetWaypointRoute_Request * ros_message = _ros_message;
  {  // header
...
PyObject * autoware_planning_msgs__srv__set_waypoint_route__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_planning_msgs.srv._set_waypoint_route");
...
ROSIDL_GENERATOR_C_EXPORT
bool autoware_planning_msgs__srv__set_waypoint_route__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_planning_msgs.srv._set_waypoint_route.SetWaypointRoute_Response", full_classname_dest, 72) == 0);
  }
  autoware_planning_msgs__srv__SetWaypointRoute_Response * ros_message = _ros_message;
  {  // status
