...
#include "autoware_planning_msgs/msg/detail/route_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_planning_msgs::msg::RouteState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_planning_msgs::msg::RouteState & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_planning_msgs::msg::RouteState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_planning_msgs::msg::RouteState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_planning_msgs::msg::RouteState *>(
    untyped_ros_message);
...
{
  return &autoware_planning_msgs::msg::typesupport_fastrtps_cpp::_RouteState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_planning_msgs, msg, RouteState)() {
  return &autoware_planning_msgs::msg::typesupport_fastrtps_cpp::_RouteState__handle;
}
