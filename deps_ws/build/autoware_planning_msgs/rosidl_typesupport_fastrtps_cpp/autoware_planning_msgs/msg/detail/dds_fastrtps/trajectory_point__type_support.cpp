...
#include "autoware_planning_msgs/msg/detail/trajectory_point__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_planning_msgs::msg::TrajectoryPoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_planning_msgs::msg::TrajectoryPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_planning_msgs::msg::TrajectoryPoint *>(
    untyped_ros_message);
...
{
  return &autoware_planning_msgs::msg::typesupport_fastrtps_cpp::_TrajectoryPoint__handle;
}
