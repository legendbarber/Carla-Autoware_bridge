...
#include "autoware_planning_msgs/srv/detail/set_waypoint_route__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_planning_msgs::srv::SetWaypointRoute_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_planning_msgs::srv::SetWaypointRoute_Request & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_planning_msgs::srv::SetWaypointRoute_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_planning_msgs::srv::SetWaypointRoute_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_planning_msgs::srv::SetWaypointRoute_Request *>(
    untyped_ros_message);
...
{
  return &autoware_planning_msgs::srv::typesupport_fastrtps_cpp::_SetWaypointRoute_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_planning_msgs, srv, SetWaypointRoute_Request)() {
  return &autoware_planning_msgs::srv::typesupport_fastrtps_cpp::_SetWaypointRoute_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_autoware_planning_msgs
cdr_serialize(
  const autoware_planning_msgs::srv::SetWaypointRoute_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_planning_msgs::srv::SetWaypointRoute_Response & ros_message)
{
  // Member: status
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = autoware_planning_msgs::srv::SetWaypointRoute_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_planning_msgs::srv::SetWaypointRoute_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<autoware_planning_msgs::srv::SetWaypointRoute_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &autoware_planning_msgs::srv::typesupport_fastrtps_cpp::_SetWaypointRoute_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_planning_msgs, srv, SetWaypointRoute_Response)() {
  return &autoware_planning_msgs::srv::typesupport_fastrtps_cpp::_SetWaypointRoute_Response__handle;
}
...
{
  return &autoware_planning_msgs::srv::typesupport_fastrtps_cpp::_SetWaypointRoute__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_planning_msgs, srv, SetWaypointRoute)() {
  return &autoware_planning_msgs::srv::typesupport_fastrtps_cpp::_SetWaypointRoute__handle;
}
