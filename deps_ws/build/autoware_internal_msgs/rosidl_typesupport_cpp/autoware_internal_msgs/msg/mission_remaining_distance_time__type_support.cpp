...
static const _MissionRemainingDistanceTime_type_support_symbol_names_t _MissionRemainingDistanceTime_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_internal_msgs, msg, MissionRemainingDistanceTime)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_internal_msgs, msg, MissionRemainingDistanceTime)),
  }
};
...
{
  return &::autoware_internal_msgs::msg::rosidl_typesupport_cpp::MissionRemainingDistanceTime_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, autoware_internal_msgs, msg, MissionRemainingDistanceTime)() {
  return get_message_type_support_handle<autoware_internal_msgs::msg::MissionRemainingDistanceTime>();
}
