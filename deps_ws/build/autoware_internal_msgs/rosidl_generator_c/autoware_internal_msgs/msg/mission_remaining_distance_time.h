...
#ifndef AUTOWARE_INTERNAL_MSGS__MSG__MISSION_REMAINING_DISTANCE_TIME_H_
#define AUTOWARE_INTERNAL_MSGS__MSG__MISSION_REMAINING_DISTANCE_TIME_H_
...
#endif  // AUTOWARE_INTERNAL_MSGS__MSG__MISSION_REMAINING_DISTANCE_TIME_H_
