...
#ifndef AUTOWARE_INTERNAL_PLANNING_MSGS__MSG__DETAIL__SCENARIO__TRAITS_HPP_
#define AUTOWARE_INTERNAL_PLANNING_MSGS__MSG__DETAIL__SCENARIO__TRAITS_HPP_
...
inline void to_yaml(
  const autoware_internal_planning_msgs::msg::Scenario & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const autoware_internal_planning_msgs::msg::Scenario & msg)
{
  return autoware_internal_planning_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<autoware_internal_planning_msgs::msg::Scenario>()
{
  return "autoware_internal_planning_msgs::msg::Scenario";
}

template<>
inline const char * name<autoware_internal_planning_msgs::msg::Scenario>()
{
  return "autoware_internal_planning_msgs/msg/Scenario";
}

template<>
struct has_fixed_size<autoware_internal_planning_msgs::msg::Scenario>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<autoware_internal_planning_msgs::msg::Scenario>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<autoware_internal_planning_msgs::msg::Scenario>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // AUTOWARE_INTERNAL_PLANNING_MSGS__MSG__DETAIL__SCENARIO__TRAITS_HPP_
