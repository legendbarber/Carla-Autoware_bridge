...
{
  new (message_memory) autoware_internal_planning_msgs::msg::Scenario(_init);
}

void Scenario_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_internal_planning_msgs::msg::Scenario *>(message_memory);
...
void fetch_function__Scenario__activating_scenarios(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const std::string *>(
    get_const_function__Scenario__activating_scenarios(untyped_member, index));
  auto & value = *reinterpret_cast<std::string *>(untyped_value);
  value = item;
}

void assign_function__Scenario__activating_scenarios(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<std::string *>(
    get_function__Scenario__activating_scenarios(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Scenario_message_member_array[2] = {
  {
    ...
    offsetof(autoware_internal_planning_msgs::msg::Scenario, current_scenario),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_internal_planning_msgs::msg::Scenario, activating_scenarios),  // bytes offset in struct
    nullptr,  // default value
    ...
    fetch_function__Scenario__activating_scenarios,  // fetch(index, &value) function pointer
    assign_function__Scenario__activating_scenarios,  // assign(index, value) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Scenario_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_internal_planning_msgs::msg::Scenario),
...
get_message_type_support_handle<autoware_internal_planning_msgs::msg::Scenario>()
{
  return &::autoware_internal_planning_msgs::msg::rosidl_typesupport_introspection_cpp::Scenario_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_internal_planning_msgs, msg, Scenario)() {
  return &::autoware_internal_planning_msgs::msg::rosidl_typesupport_introspection_cpp::Scenario_message_type_support_handle;
}
