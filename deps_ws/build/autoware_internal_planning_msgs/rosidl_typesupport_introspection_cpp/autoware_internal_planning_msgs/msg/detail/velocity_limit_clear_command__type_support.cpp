...
{
  new (message_memory) autoware_internal_planning_msgs::msg::VelocityLimitClearCommand(_init);
}

void VelocityLimitClearCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_internal_planning_msgs::msg::VelocityLimitClearCommand *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember VelocityLimitClearCommand_message_member_array[3] = {
  {
    ...
    offsetof(autoware_internal_planning_msgs::msg::VelocityLimitClearCommand, stamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_internal_planning_msgs::msg::VelocityLimitClearCommand, command),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_internal_planning_msgs::msg::VelocityLimitClearCommand, sender),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers VelocityLimitClearCommand_message_members = {
  ...
  3,  // number of fields
  sizeof(autoware_internal_planning_msgs::msg::VelocityLimitClearCommand),
...
get_message_type_support_handle<autoware_internal_planning_msgs::msg::VelocityLimitClearCommand>()
{
  return &::autoware_internal_planning_msgs::msg::rosidl_typesupport_introspection_cpp::VelocityLimitClearCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_internal_planning_msgs, msg, VelocityLimitClearCommand)() {
  return &::autoware_internal_planning_msgs::msg::rosidl_typesupport_introspection_cpp::VelocityLimitClearCommand_message_type_support_handle;
}
