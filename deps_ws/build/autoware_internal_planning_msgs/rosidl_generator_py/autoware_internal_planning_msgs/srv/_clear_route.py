...
class Metaclass_ClearRoute(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'autoware_internal_planning_msgs.srv.ClearRoute')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from autoware_internal_planning_msgs.srv import _clear_route
...
class ClearRoute(metaclass=Metaclass_ClearRoute):
    from autoware_internal_planning_msgs.srv._clear_route import ClearRoute_Request as Request
    from autoware_internal_planning_msgs.srv._clear_route import ClearRoute_Response as Response
