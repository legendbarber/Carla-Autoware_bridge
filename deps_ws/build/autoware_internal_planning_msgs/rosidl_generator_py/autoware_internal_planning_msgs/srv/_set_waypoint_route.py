...
class Metaclass_SetWaypointRoute(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'autoware_internal_planning_msgs.srv.SetWaypointRoute')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from autoware_internal_planning_msgs.srv import _set_waypoint_route
...
class SetWaypointRoute(metaclass=Metaclass_SetWaypointRoute):
    from autoware_internal_planning_msgs.srv._set_waypoint_route import SetWaypointRoute_Request as Request
    from autoware_internal_planning_msgs.srv._set_waypoint_route import SetWaypointRoute_Response as Response
