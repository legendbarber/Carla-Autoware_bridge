...
class Metaclass_UnloadPlugin(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'autoware_internal_planning_msgs.srv.UnloadPlugin')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from autoware_internal_planning_msgs.srv import _unload_plugin
...
class UnloadPlugin(metaclass=Metaclass_UnloadPlugin):
    from autoware_internal_planning_msgs.srv._unload_plugin import UnloadPlugin_Request as Request
    from autoware_internal_planning_msgs.srv._unload_plugin import UnloadPlugin_Response as Response
