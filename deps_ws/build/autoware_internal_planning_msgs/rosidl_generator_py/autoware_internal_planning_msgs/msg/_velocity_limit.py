...
class Metaclass_VelocityLimit(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from autoware_internal_planning_msgs.msg import VelocityLimitConstraints
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'SENDER_API': cls.__constants['SENDER_API'],
            'USE_CONSTRAINTS__DEFAULT': False,
        }

    @property
    def SENDER_API(self):
        """Message constant 'SENDER_API'."""
        return Metaclass_VelocityLimit.__constants['SENDER_API']
...
class VelocityLimit(metaclass=Metaclass_VelocityLimit):
    ...
    _fields_and_field_types = {
        ...
        'constraints': 'autoware_internal_planning_msgs/VelocityLimitConstraints',
        'sender': 'string',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['autoware_internal_planning_msgs', 'msg'], 'VelocityLimitConstraints'),  # noqa: E501
