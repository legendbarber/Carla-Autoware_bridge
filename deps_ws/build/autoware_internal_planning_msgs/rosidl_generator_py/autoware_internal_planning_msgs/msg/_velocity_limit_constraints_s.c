...
bool autoware_internal_planning_msgs__msg__velocity_limit_constraints__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_internal_planning_msgs.msg._velocity_limit_constraints.VelocityLimitConstraints", full_classname_dest, 88) == 0);
  }
  autoware_internal_planning_msgs__msg__VelocityLimitConstraints * ros_message = _ros_message;
  {  // max_acceleration
...
PyObject * autoware_internal_planning_msgs__msg__velocity_limit_constraints__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_internal_planning_msgs.msg._velocity_limit_constraints");
