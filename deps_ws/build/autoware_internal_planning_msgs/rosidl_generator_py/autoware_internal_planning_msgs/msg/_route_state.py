...
class Metaclass_RouteState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'autoware_internal_planning_msgs.msg.RouteState')
            logger.debug(
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'REROUTING': cls.__constants['REROUTING'],
            'ARRIVED': cls.__constants['ARRIVED'],
            'ABORTED': cls.__constants['ABORTED'],
            'INTERRUPTED': cls.__constants['INTERRUPTED'],
        }
    ...
    def INITIALIZING(self):
        ...
        return Metaclass_RouteState.__constants['INITIALIZING']
    ...
    @property
    def REROUTING(self):
        """Message constant 'REROUTING'."""
        return Metaclass_RouteState.__constants['REROUTING']
    ...
    def ABORTED(self):
        ...
        return Metaclass_RouteState.__constants['ABORTED']

    @property
    def INTERRUPTED(self):
        """Message constant 'INTERRUPTED'."""
        return Metaclass_RouteState.__constants['INTERRUPTED']
