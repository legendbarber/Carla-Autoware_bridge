...
#include "autoware_internal_planning_msgs/msg/detail/velocity_limit__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const autoware_internal_planning_msgs::msg::VelocityLimitConstraints &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  autoware_internal_planning_msgs::msg::VelocityLimitConstraints &);
size_t get_serialized_size(
  const autoware_internal_planning_msgs::msg::VelocityLimitConstraints &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const autoware_internal_planning_msgs::msg::VelocityLimit & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_internal_planning_msgs::msg::VelocityLimit & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  // Member: constraints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        autoware_internal_planning_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_VelocityLimitConstraints(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = autoware_internal_planning_msgs::msg::VelocityLimit;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_internal_planning_msgs::msg::VelocityLimit *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_internal_planning_msgs::msg::VelocityLimit *>(
    untyped_ros_message);
...
{
  return &autoware_internal_planning_msgs::msg::typesupport_fastrtps_cpp::_VelocityLimit__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_internal_planning_msgs, msg, VelocityLimit)() {
  return &autoware_internal_planning_msgs::msg::typesupport_fastrtps_cpp::_VelocityLimit__handle;
}
