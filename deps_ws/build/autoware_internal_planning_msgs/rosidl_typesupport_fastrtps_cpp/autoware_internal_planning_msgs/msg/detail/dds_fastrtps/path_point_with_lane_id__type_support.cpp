...
#include "autoware_internal_planning_msgs/msg/detail/path_point_with_lane_id__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_internal_planning_msgs::msg::PathPointWithLaneId & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_internal_planning_msgs::msg::PathPointWithLaneId & ros_message)
{
  // Member: point
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_internal_planning_msgs::msg::PathPointWithLaneId;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_internal_planning_msgs::msg::PathPointWithLaneId *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_internal_planning_msgs::msg::PathPointWithLaneId *>(
    untyped_ros_message);
...
{
  return &autoware_internal_planning_msgs::msg::typesupport_fastrtps_cpp::_PathPointWithLaneId__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_internal_planning_msgs, msg, PathPointWithLaneId)() {
  return &autoware_internal_planning_msgs::msg::typesupport_fastrtps_cpp::_PathPointWithLaneId__handle;
}
