...
#include "autoware_internal_planning_msgs/msg/detail/velocity_limit_clear_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_internal_planning_msgs::msg::VelocityLimitClearCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_internal_planning_msgs::msg::VelocityLimitClearCommand & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_internal_planning_msgs::msg::VelocityLimitClearCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_internal_planning_msgs::msg::VelocityLimitClearCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_internal_planning_msgs::msg::VelocityLimitClearCommand *>(
    untyped_ros_message);
...
{
  return &autoware_internal_planning_msgs::msg::typesupport_fastrtps_cpp::_VelocityLimitClearCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_internal_planning_msgs, msg, VelocityLimitClearCommand)() {
  return &autoware_internal_planning_msgs::msg::typesupport_fastrtps_cpp::_VelocityLimitClearCommand__handle;
}
