...
#include "autoware_internal_planning_msgs/msg/detail/scenario__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_internal_planning_msgs::msg::Scenario & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_internal_planning_msgs::msg::Scenario & ros_message)
{
  // Member: current_scenario
  cdr >> ros_message.current_scenario;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_internal_planning_msgs::msg::Scenario;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_internal_planning_msgs::msg::Scenario *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_internal_planning_msgs::msg::Scenario *>(
    untyped_ros_message);
...
{
  return &autoware_internal_planning_msgs::msg::typesupport_fastrtps_cpp::_Scenario__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_internal_planning_msgs, msg, Scenario)() {
  return &autoware_internal_planning_msgs::msg::typesupport_fastrtps_cpp::_Scenario__handle;
}
