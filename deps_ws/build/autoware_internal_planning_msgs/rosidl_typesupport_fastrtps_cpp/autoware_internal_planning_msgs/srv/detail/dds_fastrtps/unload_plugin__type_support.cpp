...
#include "autoware_internal_planning_msgs/srv/detail/unload_plugin__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_internal_planning_msgs::srv::UnloadPlugin_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_internal_planning_msgs::srv::UnloadPlugin_Request & ros_message)
{
  // Member: plugin_name
  cdr >> ros_message.plugin_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_internal_planning_msgs::srv::UnloadPlugin_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_internal_planning_msgs::srv::UnloadPlugin_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_internal_planning_msgs::srv::UnloadPlugin_Request *>(
    untyped_ros_message);
...
{
  return &autoware_internal_planning_msgs::srv::typesupport_fastrtps_cpp::_UnloadPlugin_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_internal_planning_msgs, srv, UnloadPlugin_Request)() {
  return &autoware_internal_planning_msgs::srv::typesupport_fastrtps_cpp::_UnloadPlugin_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_autoware_internal_planning_msgs
cdr_serialize(
  const autoware_internal_planning_msgs::srv::UnloadPlugin_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_internal_planning_msgs::srv::UnloadPlugin_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = autoware_internal_planning_msgs::srv::UnloadPlugin_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_internal_planning_msgs::srv::UnloadPlugin_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<autoware_internal_planning_msgs::srv::UnloadPlugin_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &autoware_internal_planning_msgs::srv::typesupport_fastrtps_cpp::_UnloadPlugin_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_internal_planning_msgs, srv, UnloadPlugin_Response)() {
  return &autoware_internal_planning_msgs::srv::typesupport_fastrtps_cpp::_UnloadPlugin_Response__handle;
}
...
{
  return &autoware_internal_planning_msgs::srv::typesupport_fastrtps_cpp::_UnloadPlugin__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_internal_planning_msgs, srv, UnloadPlugin)() {
  return &autoware_internal_planning_msgs::srv::typesupport_fastrtps_cpp::_UnloadPlugin__handle;
}
