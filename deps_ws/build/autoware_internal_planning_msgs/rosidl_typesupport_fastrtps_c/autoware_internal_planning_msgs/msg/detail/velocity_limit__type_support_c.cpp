...
#include "autoware_internal_planning_msgs/msg/detail/velocity_limit__rosidl_typesupport_fastrtps_c.h"
...
#include "autoware_internal_planning_msgs/msg/detail/velocity_limit_constraints__functions.h"  // constraints
...
using _VelocityLimit__ros_msg_type = autoware_internal_planning_msgs__msg__VelocityLimit;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: constraints
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, autoware_internal_planning_msgs, msg, VelocityLimitConstraints
      )()->data);
    if (!callbacks->cdr_serialize(
...
size_t get_serialized_size_autoware_internal_planning_msgs__msg__VelocityLimit(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VelocityLimit__ros_msg_type * ros_message = static_cast<const _VelocityLimit__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_autoware_internal_planning_msgs__msg__VelocityLimitConstraints(
...
static uint32_t _VelocityLimit__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_internal_planning_msgs__msg__VelocityLimit(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_internal_planning_msgs
size_t max_serialized_size_autoware_internal_planning_msgs__msg__VelocityLimit(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: constraints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_autoware_internal_planning_msgs__msg__VelocityLimitConstraints(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = autoware_internal_planning_msgs__msg__VelocityLimit;
    is_plain =
      (
...
static size_t _VelocityLimit__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autoware_internal_planning_msgs__msg__VelocityLimit(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_internal_planning_msgs, msg, VelocityLimit)() {
