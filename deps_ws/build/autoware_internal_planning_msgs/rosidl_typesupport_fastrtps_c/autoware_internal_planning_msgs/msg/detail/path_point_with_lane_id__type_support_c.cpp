...
#include "autoware_internal_planning_msgs/msg/detail/path_point_with_lane_id__rosidl_typesupport_fastrtps_c.h"
...
#include "autoware_planning_msgs/msg/detail/path_point__functions.h"  // point
...
using _PathPointWithLaneId__ros_msg_type = autoware_internal_planning_msgs__msg__PathPointWithLaneId;
  ...
  // Field name: point
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, autoware_planning_msgs, msg, PathPoint
      )()->data);
...
static uint32_t _PathPointWithLaneId__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_internal_planning_msgs__msg__PathPointWithLaneId(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_internal_planning_msgs__msg__PathPointWithLaneId;
    is_plain =
      (
...
static size_t _PathPointWithLaneId__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autoware_internal_planning_msgs__msg__PathPointWithLaneId(
