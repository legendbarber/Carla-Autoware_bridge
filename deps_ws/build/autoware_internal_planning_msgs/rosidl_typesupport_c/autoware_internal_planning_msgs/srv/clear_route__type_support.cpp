...
static const _ClearRoute_Request_type_support_symbol_names_t _ClearRoute_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_internal_planning_msgs, srv, ClearRoute_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_internal_planning_msgs, srv, ClearRoute_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_internal_planning_msgs, srv, ClearRoute_Request)() {
  return &::autoware_internal_planning_msgs::srv::rosidl_typesupport_c::ClearRoute_Request_message_type_support_handle;
}
...
static const _ClearRoute_Response_type_support_symbol_names_t _ClearRoute_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_internal_planning_msgs, srv, ClearRoute_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_internal_planning_msgs, srv, ClearRoute_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_internal_planning_msgs, srv, ClearRoute_Response)() {
  return &::autoware_internal_planning_msgs::srv::rosidl_typesupport_c::ClearRoute_Response_message_type_support_handle;
}
...
static const _ClearRoute_type_support_symbol_names_t _ClearRoute_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_internal_planning_msgs, srv, ClearRoute)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_internal_planning_msgs, srv, ClearRoute)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, autoware_internal_planning_msgs, srv, ClearRoute)() {
  return &::autoware_internal_planning_msgs::srv::rosidl_typesupport_c::ClearRoute_service_type_support_handle;
}
