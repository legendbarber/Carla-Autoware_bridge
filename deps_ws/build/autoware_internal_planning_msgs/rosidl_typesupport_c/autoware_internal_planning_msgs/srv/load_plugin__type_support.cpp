...
static const _LoadPlugin_Request_type_support_symbol_names_t _LoadPlugin_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_internal_planning_msgs, srv, LoadPlugin_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_internal_planning_msgs, srv, LoadPlugin_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_internal_planning_msgs, srv, LoadPlugin_Request)() {
  return &::autoware_internal_planning_msgs::srv::rosidl_typesupport_c::LoadPlugin_Request_message_type_support_handle;
}
...
static const _LoadPlugin_Response_type_support_symbol_names_t _LoadPlugin_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_internal_planning_msgs, srv, LoadPlugin_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_internal_planning_msgs, srv, LoadPlugin_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_internal_planning_msgs, srv, LoadPlugin_Response)() {
  return &::autoware_internal_planning_msgs::srv::rosidl_typesupport_c::LoadPlugin_Response_message_type_support_handle;
}
...
static const _LoadPlugin_type_support_symbol_names_t _LoadPlugin_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_internal_planning_msgs, srv, LoadPlugin)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_internal_planning_msgs, srv, LoadPlugin)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, autoware_internal_planning_msgs, srv, LoadPlugin)() {
  return &::autoware_internal_planning_msgs::srv::rosidl_typesupport_c::LoadPlugin_service_type_support_handle;
}
