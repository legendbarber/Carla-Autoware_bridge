...
static const _VelocityLimit_type_support_symbol_names_t _VelocityLimit_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_internal_planning_msgs, msg, VelocityLimit)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_internal_planning_msgs, msg, VelocityLimit)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_internal_planning_msgs, msg, VelocityLimit)() {
  return &::autoware_internal_planning_msgs::msg::rosidl_typesupport_c::VelocityLimit_message_type_support_handle;
}
