...
static const _VelocityLimitClearCommand_type_support_symbol_names_t _VelocityLimitClearCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_internal_planning_msgs, msg, VelocityLimitClearCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_internal_planning_msgs, msg, VelocityLimitClearCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_internal_planning_msgs, msg, VelocityLimitClearCommand)() {
  return &::autoware_internal_planning_msgs::msg::rosidl_typesupport_c::VelocityLimitClearCommand_message_type_support_handle;
}
