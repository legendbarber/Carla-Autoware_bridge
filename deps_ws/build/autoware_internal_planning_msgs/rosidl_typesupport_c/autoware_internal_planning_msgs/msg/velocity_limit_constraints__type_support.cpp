...
static const _VelocityLimitConstraints_type_support_symbol_names_t _VelocityLimitConstraints_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_internal_planning_msgs, msg, VelocityLimitConstraints)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_internal_planning_msgs, msg, VelocityLimitConstraints)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_internal_planning_msgs, msg, VelocityLimitConstraints)() {
  return &::autoware_internal_planning_msgs::msg::rosidl_typesupport_c::VelocityLimitConstraints_message_type_support_handle;
}
