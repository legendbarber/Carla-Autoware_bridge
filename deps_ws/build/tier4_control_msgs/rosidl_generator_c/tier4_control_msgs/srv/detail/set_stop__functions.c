  ...
  tier4_control_msgs__srv__SetStop_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_control_msgs__srv__SetStop_Request * data =
      (tier4_control_msgs__srv__SetStop_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_control_msgs__srv__SetStop_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tier4_control_msgs__srv__SetStop_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  tier4_control_msgs__srv__SetStop_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_control_msgs__srv__SetStop_Response * data =
      (tier4_control_msgs__srv__SetStop_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_control_msgs__srv__SetStop_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tier4_control_msgs__srv__SetStop_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
