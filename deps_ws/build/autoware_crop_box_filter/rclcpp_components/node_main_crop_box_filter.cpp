...
#define NODE_MAIN_LOGGER_NAME "crop_box_filter"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcrop_box_filter_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<autoware::crop_box_filter::CropBoxFilter>";
